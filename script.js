    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ההופעות של יובל משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'a2d0e746-8f43-452c-9e6d-a22bf8be1547',
                    name: data.name || '',
                    email: data.email || '',
